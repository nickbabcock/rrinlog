...
pub enum DataError {
    ...
    #[fail(display = "Unable to execute query: {}: {}", _0, _1)] DbQuery(String, #[cause] DsError),

    #[fail(display = "One target expected: {} received", _0)] OneTarget(usize),

    #[fail(display = "Unrecognized target: {}", _0)] UnrecognizedTarget(String),
